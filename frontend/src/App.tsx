  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/presentations/:id/configure" element={<AdminShell><ConfigureSlides /></AdminShell>} />
        <Route path="/admin/sessions/:code" element={<AdminShell><ControlSession /></AdminShell>} />
        <Route path="/admin/sessions/:code/results" element={<AdminShell><SessionResults /></AdminShell>} />
